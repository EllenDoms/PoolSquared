  ...
  render() {
    ...
    return (
      <div id="passwordStrength">
        <div className="active strength strength1" />
        <div className={strength > 0 ? 'active strength strength2' : 'strength strength2' } />
        <div className={strength > 1 ? 'active strength strength3' : 'strength strength3' } />
      </div>
    )
  }
}
